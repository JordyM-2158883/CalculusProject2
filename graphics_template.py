...
def draw_pixel(canvas, xp, yp, fill_col):
    ...
    canvas.create_line(
        vp_point[0], vp_point[1], vp_point[0] + 1, vp_point[1] + 1, fill=fill_col
    )
...
def draw_dot(canvas, xd, yd, fill_col):
    ...
    canvas.create_oval(
        vp_dot[0] - r, vp_dot[1] - r, vp_dot[0] + r, vp_dot[1] + r, fill=fill_col
    )
...
def draw_line(canvas, x0, y0, x1, y1, fill_col):
    ...
    canvas.create_line(vp_p0[0], vp_p0[1], vp_p1[0], vp_p1[1], fill=fill_col)
...
def draw_rect(canvas, x0, y0, x1, y1, fill_col, to_be_filled):
    ...
    if to_be_filled:
        canvas.create_rectangle(
            vp_p0[0], vp_p0[1], vp_p1[0], vp_p1[1], fill=fill_col, outline=fill_col
        )
    else:
        canvas.create_rectangle(
            vp_p0[0], vp_p0[1], vp_p1[0], vp_p1[1], outline=fill_col
        )
...
def draw_circle(canvas, xc, yc, r, fill_col, to_be_filled):
    ...
    if to_be_filled:
        canvas.create_oval(
            vp_c[0] - r, vp_c[1] - r, vp_c[0] + r, vp_c[1] + r, fill=fill_col
        )
    else:
        canvas.create_oval(
            vp_c[0] - r, vp_c[1] - r, vp_c[0] + r, vp_c[1] + r, outline=fill_col
        )
...
def draw_small_square(canvas, xc, yc, fill_col):
    size = 0.05
